...
import logo from './img/logomain/cleanlogo.png';
import logoFood from './img/logomenu/foodlogo.png';
import logoDrink from './img/logomenu/drinklogo.png';
import logohomemenu from './img/logomenu/home.png';
import logoreciptmenu from './img/logomenu/recipe.png';
import logocontactmenu from './img/logomenu/contact.png';
...
export class Main extends Component{
	...
	changeStateContentFood=()=>{
		...
		for(var i=0;i<1;i++){
			ArrayBox.push(<div> 
				...
				<Food backgroundColor="#BDBDBD"/></div>);
			}
	...
	changeStateContentFoodSecond=()=>{
		...
		for(var l=0;l<1;l++){
			ArrayBox.push(<div><div className="position-closeBtn">
				<a href="#" className="closebtn" onClick={this.stateCloseContentFood} value={this.state.keyCloseMenu}>&times;</a> </div>
				<FoodSecond backgroundColor="#BDBDBD"/>
				</div>);
		}
	...
	changeStateContentFoodThird=()=>{
		...
		for(var i=0;i<1;i++){
			ArrayBox.push(<div>
				<div className="position-closeBtn">
				<a href="#" className="closebtn" onClick={this.stateCloseContentFood} value={this.state.keyCloseMenu}>&times;</a> </div>
				<FoodThird backgroundColor="#BDBDBD"/>
				</div>);
		}
	...
	changeStateOpenContentDrinkFirst=()=>{
		...
		for(var i=0;i<1;i++){
			ArrayBox.push(<div><div className="position-closeBtn"> 
				<a href="#" className="closebtn" onClick={this.stateCloseContentFood} value={this.state.keyCloseMenu}>&times;</a></div>
				<Drink backgroundColor="#BDBDBD"/></div>);
		}
		document.getElementById("ContentDrink").style.width="0px";
		document.getElementById("ContentDrink").style.height="0px";
	}
	...
	changeStateOpenContentDrinkSecond=()=>{
		...
		for(var i=0;i<1;i++){
			ArrayBox.push(<div><div className="position-closeBtn"> 
				<a href="#" className="closebtn" onClick={this.stateCloseContentFood} value={this.state.keyCloseMenu}>&times;</a></div>
				<DrinkSecond backgroundColor="#BDBDBD"/>
				</div>);
		}
		document.getElementById("ContentDrink").style.width="0px";
		document.getElementById("ContentDrink").style.height="0px";
	...
	changeStateOpenContentDrinkThird=()=>{
		...
		for(var i=0;i<1;i++){
			ArrayBox.push(<div><div className="position-closeBtn"> 
				<a href="#" className="closebtn" onClick={this.stateCloseContentFood} value={this.state.keyCloseMenu}>&times;</a></div>
				<DrinkThird backgroundColor="#BDBDBD"/></div>);
		}
		document.getElementById("ContentDrink").style.width="0px";
		document.getElementById("ContentDrink").style.height="0px";
	}
				...
				<Video /> 
							...
							<div id="mySidenav" className="sidenav" >
								...
								<div className="row">
									<div className="col-md-2">
										<img src={logohomemenu} alt="logomenu" className="menu-crop-photo"/>
									</div>
									<div className="col-md-2">
                    			...
                    			<div className="row">
                    				<div className="col-md-2">
                    					<img src={logoreciptmenu} alt="logo" className="menu-crop-photo"/>
                    				</div>
                    				<div className="col-md-2">
                    			...
                    			<div className="row">
                    				<div className="col-md-2">
                    					<img src={logocontactmenu} alt="logo" className="menu-crop-photo"/>
                    				</div>
                    				<div className="col-md-2">                                       
                    	...
                    	<div className="col-md-7">
                    		<div className="row">
								...
								<div className="col-md-5" onClick={this.stateOnClickFoodCourseSecond} value={this.state.keyFoodMenuSecond}>
									<div id="myTopbarSecond" className="sideTopRight" onClick={this.stateCloseTopbar}>
											<div className="row" >
												<div className="box-photo-topbar">
                    ...
                    <div id="Home" className="home-header">
                    	<div className="home-block-style">
							...
							<h3 className="header-font-style">It isn’t as scary, or as limiting, as it sounds.</h3>
							</div>
                    	</div>
                    </div>
                    </div>
